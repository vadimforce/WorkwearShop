...
namespace Магазин_спецодежды
{
    partial class BugReportForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Заметили ошибку в работе системы?\r\nОставьте здесь своё сообщение, администраторы\r" +
    "\nисправят, найденную вами недоработку.";
